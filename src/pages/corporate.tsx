...
const Corporate = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Corporate Event Planning in Atlanta | Strategic &amp; Executive Events
          | E&amp;P Events
        </title>
        ...
        <link
          rel="canonical"
          href="https://eandp.events/corporate"
        />
        ...
        <meta
          property="og:url"
          content="https://eandp.events/corporate"
        />
        ...
        <meta
          property="og:title"
          content="Corporate Event Planning in Atlanta | Strategic & Executive Events | E&P Events"
        />
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Corporate",
                item: "https://eandp.events/corporate",
              },
            ],
          }),
        }}
      ...
      <div className="min-h-screen bg-transparent flex flex-col">
        ...
        >
          ...
          <div className="relative z-20 max-w-4xl text-center mx-auto">
            <p className="text-lg md:text-xl max-w-3xl mb-10 text-white/90 mx-auto">
              Based in Atlanta, we specialize in corporate event planning that
              transcends logistics. From executive summits to brand activations,
              we align purpose with precision—leading with structure, cultural
              fluency, and decades of experience.
            </p>
        ...
        >
          <div className="text-center mb-16">
            <h2 className="section-title text-white">
              What You Need from an Atlanta Corporate Event Planner
            </h2>

            <p className="text-lg max-w-3xl mx-auto text-white">
              Planning an Atlanta-based, high-stakes corporate event means
              juggling timelines, stakeholder expectations, and brand
              integrity—often under intense pressure. Most planners coordinate.
              We take ownership, so you can lead the room, not run it.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="flex flex-col items-center text-center p-6 bg-white shadow-sm rounded-lg">
              ...
              <h3 className="text-xl font-semibold mb-2 text-[#2a2a3a]">
                Tight timelines?
              </h3>

              <p className="text-lg text-[#7b6535]">
                Delivered.
              </p>
            </div>
        ...
        <section
          id="how-it-works"
          className="bg-transparent py-20 px-6 md:px-12 lg:px-16"
        >
              ...
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-lg">
                      {index === 0 &&
                        "We begin with your purpose and goals — then map backward to build the right experience."}

                      {index === 1 &&
                        "We manage vendors, tech, and timelines to ensure nothing slips through the cracks."}

                      {index === 2 &&
                        "We run the event so you can focus on your audience — and the outcomes that matter."}
                    </p>
                  </div>
                </div>
              ))}
        ...
        <section
          id="partners"
          className="section-container bg-white text-black py-20"
        >
        ...
        <section className="text-lg text-black my-12 max-w-4xl mx-auto text-center">
          <p>
            ...
            <b>corporate event planner in Atlanta</b>? With over a decade of
            experience, E&amp;P Events partners with executive teams, nonprofits,
            and brands to produce high-impact summits, launches, and activations
            — all with precision and cultural fluency. Whether you need a
            full-service event team or a partner to handle the details, our
            Atlanta-based planners bring experience, speed, and results.
          </p>
        </section>
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <h2 className="section-title text-white">
              Lead the Room. We’ll Run the Rest.
            </h2>

            <p className="text-lg mb-10 max-w-2xl mx-auto text-white/90">
              Let’s build a corporate event that drives outcomes. Our
              Atlanta-based team blends strategic planning with cultural fluency
              and flawless execution — so your message lands exactly where it
              should.
            </p>
    ...
    <footer className="bg-[#333333] text-white py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Experts in South Asian wedding planning, fusion weddings, corporate
              events, and more.
              <br />
              <br />
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 text-center text-sm text-gray-400">
          <p>
            &copy; {currentYear} E&amp;P Events. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
