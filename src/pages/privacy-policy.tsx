...
const PAGE_URL =
  "https://eandp.events/privacy-policy";
...
const PrivacyPolicyPage = () => {
  const pageLd = {
    ...
    url: PAGE_URL,
    description:
      "Privacy Policy for E&P Events, including information about data collection, email communications, analytics, advertising, service providers, and your privacy choices.",
    publisher: {
      "@type": "Organization",
      name: "E&P Events",
  ...
  return (
    <>
      <Helmet>
        <title>
          Privacy Policy | E&amp;P Events
        </title>

        <meta
          name="description"
          content="Read the E&P Events Privacy Policy, including how we collect, use, and protect information provided through our website and event planning services."
        />
        ...
        <meta
          property="og:title"
          content="Privacy Policy | E&P Events"
        />
            ...
            <div className="space-y-10 text-gray-700 leading-8">
              <div>
                <p>
                  ...
                  ("we," "our," or "us"), we
                  respect your privacy and are
                  committed to protecting the
                  personal information you
                  share with us. This Privacy
                  Policy explains what
                  information we collect, how
                  we use it, and the choices
                  you have when you visit our
                  website, download a free
                  resource, inquire about our
                  services, or work with us as
                  an event planning client.
                </p>

                <p className="mt-4">
                  By using our website, you
                  agree to the practices
              ...
              <div>
                ...
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  ...
                  <li>
                    ...
                    event type, date, guest
                    count, venue, and planning
                    preferences
                  </li>
                  <li>
                    ...
                    questionnaires,
                    consultation requests, or
                    discovery calls
                  </li>
                </ul>

                <p className="mt-4">
                  If you become a client, we
                  may also collect additional
              ...
              <div>
                ...
                <p>
                  If you download one of our
                  free resources, join our
                  email list, register for a
                  webinar, or request planning
              ...
              <div>
                ...
                <p>
                  ...
                  our website and improve your
                  browsing experience. This
                  may include information such
                  as your browser type, pages
                  visited, time spent on the
                  site, and referral sources.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  We may use advertising
                  platforms such as Google,
                  Facebook, Instagram, or
                  LinkedIn to measure campaign
                  performance and display
                  relevant advertisements to
              ...
              <div>
                ...
                <p>
                  If you become a client, we
                  may collect additional
                  planning information such as
                  guest details, vendor
                  contacts, venue information,
                  timelines, budgets, and
                  planning documents solely to
                  provide our event planning
                  services.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  information. While no online
                  system can guarantee
                  complete security, we take
              ...
              <div>
                ...
                <p>
                  ...
                  intended for adults planning
                  personal or business events.
